...
@UIScope
@SpringComponent
public class ItemsTable extends VerticalLayout {
    ...
    private void build() {
        ...
        addItem.addClickListener(event -> {
            ...
            itemsGrid.addItem(new Item(cost, defaultType));
        });
    ...
    public void setCompany(Company selectedCompany) {
        itemsGrid.setCompany(selectedCompany);
